...
namespace Ex03_EmpLib
{
    public class Emp        // 설계도
    {
        ...
        {
            get { return empno; }
            set { empno = value; }      // value 변수는 사용자가 주는 값을 받음.
        }
        public string Ename     // private string ename 자원에 간접적으로 get, set 사용가능
        {
            get { return ename; }
            set { ename = value; }
        }
        public int Sal      // private int sal 자원에 간접적으로 get, set 사용가능
        {
            get { return sal; }
            set { sal = value; }
        }
