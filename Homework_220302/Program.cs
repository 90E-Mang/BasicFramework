...
namespace Homework_220302
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //int unit = 10000;       // 화폐단위
            //int num = 0;            // 화폐매수
            //int sw = 0;             // 스위칭 변수, 다음 화폐 단위용
            //
            //Console.Write("금액을 입력해주세요 : ");
            //int money = Convert.ToInt32(Console.ReadLine());        // 입력받은 금액을 money 변수로 사용
            //
            //bool devide = true;         // while 문 반복용
            //while (devide)
            //{
            //    num = (int)(money / unit);
            //    Console.WriteLine($"화폐단위 : {unit}원, 화폐매수 : {num}개");
            //
            //    if (unit > 1)
            //    {
            //        money -= unit * num;
